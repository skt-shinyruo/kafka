---
title: Kafka Classic Group Rebalance Trigger Path
description: A note on who initiates classic consumer group rebalances and which events make the coordinator prepare a rebalance.
tags: ['kafka', 'consumer', 'group-coordinator', 'rebalance']
aliases:
keywords:
type: docs
---
